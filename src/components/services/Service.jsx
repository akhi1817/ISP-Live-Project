  ...
  return (
   <>
        <div className='container-fluid'>
            ...
            {/* features */}
                    <h1 className='text-dark fw-bold text-center mt-5'><i>All Plans Include</i></h1>
                    <div className='col-md-12 text-center d-flex flex-column flex-md-row justify-content-center align-items-left mt-5'>
        ...
        <div data-aos='fade-up' className='container internet-container'>
            {/* internet plans */}
            <div className='row'>
                    <h1 className='text-white text-center mt-5 fw-bold'><em>Internet Plans</em></h1>
                    <div className='col-md-12 px-3 d-flex mt-5 flex-column flex-md-row justify-content-center align-items-center'>
                    <div data-aos='fade-left' className='col-md-4 mt-5'>
                        <div className="card rounded card-container" style={{backgroundColor:'#151436'}}>
                            <div className='card-body text-center text-white'>
                                ...
                                <p className='text-white'>Donec rutrum congue</p>
                                <p className='text-white'>Quisque velit nisi</p>
                                <p className='text-white'>Pretium ut lacinia in</p>
                    ...
                    <div data-aos='zoom-in' className='col-md-4 mt-5'>
                    ...
                    <div data-aos='fade-right' className='col-md-4 mt-5'>
        ...
        <div className='container bg-light'>
            ...
            <div className='row mt-5'>
                <h1 className='display-5 text-dark text-center fw-bold mt-5'><em>Which Plan is Right For You ?</em></h1>
                    <div className='col-md-12 d-flex flex-column flex-md-row justify-content-center align-items-center pt-5'>
                        <div className='col-md-3'>
                            ...
                            <p className='text-dark fw-bold ms-5 mt-5'>Casual use</p>
                        ...
                        <div className='col-md-3'>
                            ...
                            <p className='text-dark fw-bold ms-5 mt-5'>Media Streaming</p>
                        ...
                        <div className='col-md-3'>
                            ...
                            <p className='text-dark fw-bold ms-5 mt-5'>Multi-device</p>
                        ...
                        <div className='col-md-3'>
                            ...
                            <p className='text-dark fw-bold ms-5 mt-5'>Best for businesses</p>
            ...
            <div className='row mt-5'>
                ...
                <div className='col-md-12 text-center mt-5 mb-3'>
                        <button  className='package-btn btn btn-primary rounded-pill px-4 py-4  fw-bold '>Customize Your Package<i class="bi bi-chevron-right ms-3"></i></button>
                </div>
            </div>
        </div>
         {/*F.A.Q.*/}
        <div className='container fluid mt-5'>
            <div className='row mt-3'>
                        ...
                        <div class="accordion accordion-flush" id="accordionFlushExample">
                            <div class="accordion-item ">
                              ...
                              <div id="flush-collapseOne" class="accordion-collapse collapse">
                                <div class="accordion-body">Quisque velit nisi, pretium ut lacinia in, elementum id enim. Sed porttitor lectus nibh. Sed porttitor lectus nibh. Nulla porttitor accumsan tincidunt. Sed porttitor lectus nibh. Vivamus magna justo, lacinia eget consectetur sed, convallis at tellus</div>
                              </div>
                            </div>
                ...
                <div className='col-md-12 text-center mt-5 mb-3'>
                        <button className='faq-btn btn btn-primary rounded-pill px-4 py-4  fw-bold '>Ask A Question<i class="bi bi-chevron-right ms-3"></i></button>
                </div>
            </div>
        ...
        <div className='container plans-container'>
            <div className='col-md-12 text-center px-3'>
                ...
                <button className='faq-btn btn btn-primary rounded-pill px-4 py-4  fw-bold mt-5'>View All Plans<i class="bi bi-chevron-right ms-3"></i></button>
